...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"bd44cc92-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/QueryBuilderGroup.vue?vue&type=template&id=2e99cdf1&
var QueryBuilderGroupvue_type_template_id_2e99cdf1_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',{staticClass:"vqb-group",class:_vm.classObject},[_c('v-card-title',[_c('v-select',{attrs:{"items":_vm.logicalOperatorList,"label":_vm.labels.matchType,"outlined":"","hide-details":"","dense":""},model:{value:(_vm.query.logicalOperator),callback:function ($$v) {_vm.$set(_vm.query, "logicalOperator", $$v)},expression:"query.logicalOperator"}}),(this.depth > 1)?_c('v-btn',{staticClass:"remove-button",attrs:{"color":"error","x-small":""},on:{"click":_vm.remove}},[_c('v-icon',{attrs:{"x-small":""}},[_vm._v("fa-times")])],1):_vm._e()],1),_c('v-card-text',[_c('v-row',[_c('v-col',{staticClass:"mb-2 speed-dial-container",attrs:{"sm":"12"}},[_c('v-divider'),_c('v-speed-dial',{attrs:{"bottom":"","left":"","direction":"right"},scopedSlots:_vm._u([{key:"activator",fn:function(){return [_c('v-btn',{attrs:{"color":"primary","x-small":"","fab":""},model:{value:(_vm.fab),callback:function ($$v) {_vm.fab=$$v},expression:"fab"}},[(_vm.fab)?_c('v-icon',[_vm._v("fa-times")]):_c('v-icon',[_vm._v("fa-plus")])],1)]},proxy:true}]),model:{value:(_vm.fab),callback:function ($$v) {_vm.fab=$$v},expression:"fab"}},[_c('v-btn',{attrs:{"color":"primary","small":""},on:{"click":_vm.tryAddRule}},[_vm._v(" Add Rule ")]),(this.depth < this.maxDepth)?_c('v-btn',{attrs:{"color":"primary","small":""},on:{"click":_vm.addGroup}},[_vm._v(" Add Groups ")]):_vm._e()],1)],1),_c('v-col',{attrs:{"sm":"12"}},[_c('div',{staticClass:"group-child px-5 py-2"},[(_vm.query.children.length === 0)?_c('v-alert',{attrs:{"dense":"","text":"","type":"info"}},[_vm._v(" No rules here! Add some "),_c('b',[_vm._v("rules")]),_vm._v(" or "),_c('b',[_vm._v("group of rules")]),_vm._v(" using button above. ")]):_vm._e(),_vm._l((_vm.query.children),function(child,index){return _c(child.type,{key:index,tag:"component",attrs:{"type":child.type,"query":child.query,"ruleTypes":_vm.ruleTypes,"rules":_vm.rules,"rule":_vm.ruleById(child.query.rule),"index":index,"maxDepth":_vm.maxDepth,"depth":_vm.depth + 1,"styled":_vm.styled,"labels":_vm.labels},on:{"update:query":function($event){return _vm.$set(child, "query", $event)},"child-deletion-requested":_vm.removeChild}})})],2)])],1)],1),_c('v-dialog',{attrs:{"persistent":"","max-width":"290"},model:{value:(_vm.showRuleDialog),callback:function ($$v) {_vm.showRuleDialog=$$v},expression:"showRuleDialog"}},[_c('v-card',[_c('v-card-title',{staticClass:"headline"},[_vm._v("Add new rule")]),_c('v-card-text',[_c('p',[_vm._v("Select an element to describe the rules")]),_c('v-select',{attrs:{"items":_vm.rulesList,"label":"Select rule","outlined":""},model:{value:(_vm.selectedRule),callback:function ($$v) {_vm.selectedRule=$$v},expression:"selectedRule"}})],1),_c('v-card-actions',[_c('v-spacer'),_c('v-btn',{attrs:{"color":"primary","text":""},on:{"click":function($event){_vm.showRuleDialog = false}}},[_vm._v("Cancel")]),_c('v-btn',{attrs:{"color":"primary"},on:{"click":_vm.addRule}},[_vm._v("Add new rule")])],1)],1)],1)],1)}
var QueryBuilderGroupvue_type_template_id_2e99cdf1_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/QueryBuilderGroup.vue?vue&type=template&id=2e99cdf1&
...
var QueryBuilderGroup_component = normalizeComponent(
  ...
  QueryBuilderGroupvue_type_template_id_2e99cdf1_render,
  QueryBuilderGroupvue_type_template_id_2e99cdf1_staticRenderFns,
  false,
  null,
  null,
  null
